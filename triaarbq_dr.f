...
c
c
c       ... retrieve asymmetric quadrature rule for triangles
c
c       Input:
c
c       n - the degree of the quadrature (must not exceed 48)
...
c
c
c       ... retrieve rotationally symmetric quadrature rule
c
        call triaarbq(n,vert1,vert2,vert3,rnodes,
     1     weights,numnodes)
c
