...
c
c
c       ... retrieve D_3 symmetric interpolation/quadrature rule for triangles
c
c       Input:
c
c       n - the interpolation degree (must not exceed 20)
...
c
c
c       ... retrieve D_3 symmetric inteerpolation/quadrature rule
c
        call triaintq(n,vert1,vert2,vert3,rnodes,
     1     weights,numnodes)
c
